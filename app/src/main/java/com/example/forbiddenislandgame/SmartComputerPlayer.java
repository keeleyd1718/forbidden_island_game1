    ...
    protected void receiveInfo(GameInfo info) {
        ...
        if (info instanceof FiGameState) {
            ...
            if(this.playerNum == gameState.getPlayerTurn()) {//checking if it is smart ai's turn
                ...
                game.sendAction(new FiDrawTreasureAction(this));//first draw two treasure cards
                ...
                else if(gameState.numWindStatueCards[gameState.getPlayerTurn()] == 3 && gameState.numWindStatueCards[gameState.getPlayerTurn() - 1] > 1){
                ...
                else if(gameState.numWindStatueCards[gameState.getPlayerTurn() - 1] >= 4){//if the smart ai has 4 treasure cards
                ...
                else if(gameState.numOceanChaliceCards[gameState.getPlayerTurn() - 1] >= 4){//if the smart ai has 4 treasure cards
                ...
                else if(gameState.numFireCrystalCards[gameState.getPlayerTurn() - 1] >= 4){//if the smart ai has 4 treasure cards
                ...
                else if(gameState.numEarthStoneCards[gameState.getPlayerTurn() - 1] >= 4){//if the smart ai has 4 treasure cards
